...
getIntersectionById : String -> String -> PersistentModel -> Maybe String
getIntersectionById fid1 fid2 persistentModel =
    Dict.get (Helpers.orderTuple ( fid1, fid2 )) persistentModel.intersections
